...
RCT_EXTERN_METHOD(createTracker:(NSString *)uri withSiteId:(NSString *)siteId withToken:(NSString *)token withDispatchInterval:(nonnull NSNumber *)dispatchInterval)
